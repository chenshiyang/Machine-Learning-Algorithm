...
class TrainingData:
    ...
    def normalizeData(self):
        ...
        n = len(self.data)
        sums = [0 for i in range(len(self.data[0].getFeatures()))]
        squaredSums = [0 for i in range(len(self.data[0].getFeatures()))]
        means = [0 for i in range(len(self.data[0].getFeatures()))]
        stdDevs = [0 for i in range(len(self.data[0].getFeatures()))]
